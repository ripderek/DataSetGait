...
def visualizar_todo(video_path,participante):
    ...
    while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                if pie_xd >= 560 or pie_xd_2>=560:
                    ...
                    if (contador>=25):
                        ...
                        if probabilidad_predicha >= config.precision_identificacion: 
                            ...
                            print(f"Persona identificada -> {prediccion}  con probabilidad de {probabilidad_predicha:.2f} %")
                ...
                #ontador_stream.write(f"Fotograma: {contador}")
